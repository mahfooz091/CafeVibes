...
const LoginPage = () => {
  ...
  const handleGoogleLogin = async () => {
    // In production, this triggers the Google Identity Services popup
    // and passes the resulting idToken here.
    setServerError('Google login requires GOOGLE_CLIENT_ID configuration.');
  };

  return (
    <div className="flex min-h-screen w-full bg-cream">
      <AuthIllustration
        title="Welcome back to CafeVibes"
        subtitle="Pick up right where you left off — orders, tables, and the kitchen are all waiting."
      />
      ...
      <div className="flex w-full flex-col justify-center px-6 py-12 sm:px-10 lg:w-1/2 lg:px-20">
        <div className="mx-auto w-full max-w-sm">
          ...
          >
            <h1 className="font-display text-2xl font-semibold text-coffee">Log in</h1>
            <p className="mt-1 text-sm text-coffee/60">
              Enter your details to access your CafeVibes terminal.
            </p>
